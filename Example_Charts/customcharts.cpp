...
CustomCharts::CustomCharts()//QPainter *painter)

{
    ...
    ctype = CustomCharts::Dpie;
    cltype = CustomCharts::Vertical;
    cX = 0;
    cY = 0;
    cW = 100;
    cH = 100;
...
int CustomCharts::addPiece(QString name,Qt::GlobalColor color,float Percentage)
{
    this->nPiece++;
...
int CustomCharts::addPiece(QString name, QColor color, float Percentage)
{
    this->nPiece++;
    pieceNC piece;
    piece.addName(name);
...
int CustomCharts::setCords(double x, double y, double w, double h)
{
    this->cX = x;
    this->cY = y;
    this->cW = w;
...
int CustomCharts::setLegendCords(double x, double y)
{
    this->lX = x;
    this->lY = y;
...
int CustomCharts::setType(CustomCharts::type t)
{
    this->ctype = t;
...
int CustomCharts::setLegendType(CustomCharts::legend_type t)
{
    this->cltype = t;

    return 0;
}
int CustomCharts::setFont(QFont f)
{
    this->font = f;
...
int CustomCharts::setShadows(bool ok)
{
    this->shadows = ok;
...
int CustomCharts::draw(QPainter *painter)
{
    painter->setRenderHint(QPainter::Antialiasing);
    painter->setPen(Qt::NoPen);
    if (this->ctype==CustomCharts::Pie)
    {
      pW = 0;
      double pdegree = 0;
    ...
    else if (this->ctype==CustomCharts::Dpie)
    {
        pW = 50;
        double pdegree = 0;
        QPointF p;
    ...
    else if (this->ctype==CustomCharts::Histogram)
    {
        double pDist = 15;
...
int CustomCharts::drawLegend(QPainter *painter)
{
    //double ptext = 25;
    double angle = palpha;
    painter->setPen(Qt::SolidLine);
...
QPointF CustomCharts::GetPoint(double angle, double R1, double R2)
{
    if (R1 == 0 && R2 == 0)
    {
        R1 = cW;
...
int CustomCharts::GetQuater(double angle)
{
...
double CustomCharts::Angle360(double angle)
{
    int i = (int)angle;
